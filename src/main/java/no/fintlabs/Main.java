...
import no.fintlabs.costServices.Labels;
import no.fintlabs.costServices.TeamCostService;
...
public class Main implements CommandLineRunner {
    ...
    private final TeamCostService teamCostService;

    @Autowired
    public Main(ApiService apiService, TeamCostService teamCostService) {
        this.apiService = apiService;
        this.teamCostService = teamCostService;
    }
    ...
    public void run(String... args) throws Exception {
        ...
        List<Labels> labels = teamCostService.fetchApiStatus();
